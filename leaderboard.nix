...
, bytestring, connection, cryptonite, directory, filepath, hedgehog
, http-client-tls, http-types, jose, lens, mmorph, monad-control
, monad-log, mtl, optparse-applicative, postgresql-simple
, postgresql-simple-url, product-profunctors, resource-pool, retry
, scrypt, servant, servant-auth, servant-auth-client
, servant-auth-server, servant-client, servant-server, stdenv
, tasty, tasty-hedgehog, text, time, tmp-postgres, transformers
, transformers-base, uri-bytestring, warp, warp-tls
}:
mkDerivation {
  pname = "leaderboard";
  version = "0.1.0.0";
